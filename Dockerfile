...
LABEL source.repo "https://github.com/VCityTeam/UD-Demo-Vcity-IFC-Docker"
...
RUN git clone https://github.com/VCityTeam/UD-Demo-Vcity-IFC.git
WORKDIR /UD-Demo-Vcity-IFC
RUN npm install
RUN npm run build
